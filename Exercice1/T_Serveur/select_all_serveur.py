...
try:
    ...
    mysql_select_string = "SELECT * FROM t_serveur ORDER BY ID_Serveur ASC"
    ...
    for row in records_select:
        print(row['ID_Serveur'],row['Nom_Serv'])

    for row in records_select:
        output = "id: {ID_Serveur}  Nom_Serv: {Nom_Serv}"
