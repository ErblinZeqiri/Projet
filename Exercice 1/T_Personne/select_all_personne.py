...
try:
    ...
    for row in records_select:
        print(row['ID_Personne'],row['Nom_Pers'],row['Prenom_Pers'],row['Date_Naissance_Pers'])

    for row in records_select:
        output = "id: {ID_Personne}  Nom: {Nom_Pers} Prenom: {Prenom_Pers} Date Naissance: {Date_Naissance_Pers}"
