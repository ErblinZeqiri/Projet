# select_all_location.py
# EZ 2020.04.05 le but est d'afficher tous les lignes de la table "t_genres" en MySql.
...
try:
    ...
    mysql_select_string = "SELECT * FROM t_type_equipement ORDER BY ID_Type_Equipement ASC"
    ...
    for row in records_select:
        print(row['ID_Type_Equipement'],row['Type_Equipement'])

    for row in records_select:
        output = "id: {ID_Type_Equipement}  Type_Equipement: {Type_Equipement}"
