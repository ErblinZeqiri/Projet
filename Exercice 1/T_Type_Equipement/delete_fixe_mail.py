# delete_fixe_location.py
# EZ 2020.04.05 le but est d'effacer une ligne d'une table en MySql.
...
from Exercice1.DATABASE.DELETE import delete_one_record_one_table
...
try:
    ...
    numero_ligne_table_delete = 4
    # OM 2020.03.11 Fonction DELETE avec le numéro de la ligne à effacer passée en paramètre.
    delete_record.delete_one_record_one_table("""DELETE FROM t_type_equipement WHERE ID_Type_Equipement = %(no_ligne_delete)s""",numero_ligne_table_delete)
