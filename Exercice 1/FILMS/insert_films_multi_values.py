...
try:
    # OM 2020.03.11 Démonstration en classe, juste pour "faire" un objet "objet_etre_connecte" (instancier la classe)
    ...
    valeur_1 = "humoureeee titanesquezz"
    valeur_2 = 53
    valeur_3 = "2323-11-12"
    # Lignes pour afficher les valeurs dans la console...c'est tout, vraiment tout !
    print("valeur_1 ",valeur_1, "valeur_2 ",valeur_2, "valeur_3 ",valeur_3)

    # Définitions d'un dictionnaire pour passer les valeurs en paramètres de façon un "peu" sécurisée dans la BD
    valeurs_insertion_dictionnaire = {'value_nom_film': valeur_1, 'value_duree_film': valeur_2, 'date_sortie_film': valeur_3}

=======
# insert_personne_multi_values.py
# OM 2698.03.21 Permet d'insérer plusieurs valeurs dans la table t_films
