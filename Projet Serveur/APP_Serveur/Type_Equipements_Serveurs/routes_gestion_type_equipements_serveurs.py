...
# OM 2020.04.16 Gestions des "routes" FLASK pour la table intermédiaire qui associe les serveurs et les type_equipements.
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.26 Définition d'une "route" /type_equipements_serveurs_afficher_concat
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.21 Définition d'une "route" /gf_edit_type_equipement_serveur_selected
...
def gf_edit_type_equipement_serveur_selected ():
    if request.method == "GET":
        try:
            ...
            # OM 2020.04.21 Récupère la valeur de "ID_Serveur" du formulaire html "type_equipements_serveurs_afficher.html"
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.26 Définition d'une "route" /gf_update_type_equipement_serveur_selected
# Récupère la liste de tous les type_equipements du serveur sélectionné.
# Nécessaire pour afficher tous les "TAGS" des type_equipements, ainsi l'utilisateur voit les type_equipements à disposition
# ---------------------------------------------------------------------------------------------------
...
def gf_update_type_equipement_serveur_selected ():
    if request.method == "POST":
        try:
            ...
            # OM 2020.04.29 Une liste de "ID_Type_Equipement" qui doivent être effacés de la table intermédiaire "t_pers_a_type_equipement".
            ...
            # OM 2020.04.29 Une liste de "ID_Type_Equipement" qui doivent être ajoutés à la BD
