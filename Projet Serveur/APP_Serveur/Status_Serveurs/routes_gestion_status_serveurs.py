...
# OM 2020.04.16 Gestions des "routes" FLASK pour la table intermédiaire qui associe les serveurs et les status.
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.26 Définition d'une "route" /status_serveurs_afficher_concat
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.21 Définition d'une "route" /gf_edit_status_serveur_selected
...
def gf_edit_status_serveur_selected ():
    if request.method == "GET":
        try:
            ...
            # OM 2020.04.21 Récupère la valeur de "ID_Serveur" du formulaire html "status_serveurs_afficher.html"
            ...
            # OM 2020.04.21 Mémorise l'id du serveur dans une variable de session
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.26 Définition d'une "route" /gf_update_status_serveur_selected
# Récupère la liste de tous les status du serveur sélectionné.
# Nécessaire pour afficher tous les "TAGS" des status, ainsi l'utilisateur voit les status à disposition
# ---------------------------------------------------------------------------------------------------
...
def gf_update_status_serveur_selected ():
    if request.method == "POST":
        try:
            ...
            # OM 2020.04.29 Une liste de "ID_Status" qui doivent être effacés de la table intermédiaire "t_status_serveurs".
            ...
            # OM 2020.04.29 Une liste de "ID_Status" qui doivent être ajoutés à la BD
            ...
            for ID_Status_del in lst_diff_status_delete_b:
                ...
                valeurs_serveur_sel_status_sel_dictionnaire = {"value_FK_Status": ID_Serveur_selected,
