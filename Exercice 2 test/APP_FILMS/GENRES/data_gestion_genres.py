...
# EZ 2020.04.26 Permet de gérer (CRUD) les données de la table t_genres
...
class GestionGenres():
    ...
    def edit_genre_data(self, valeur_id_dictionnaire):
        try:
            ...
            str_sql_id_genre = "SELECT ID_Personne, Nom_Pers FROM t_personne = %(value_id_genre)s"
    ...
    def delete_select_genre_data(self, valeur_delete_dictionnaire):
        try:
            ...
            # OM 2020.04.07 C'EST LA QUE VOUS ALLEZ DEVOIR PLACER VOTRE PROPRE LOGIQUE MySql
            # Commande MySql pour afficher le genre sélectionné dans le tableau dans le formulaire HTML
            str_sql_select_id_genre = "SELECT ID_Personne, Nom_Pers FROM t_personne WHERE ID_Personne = %(value_id_genre)s"
