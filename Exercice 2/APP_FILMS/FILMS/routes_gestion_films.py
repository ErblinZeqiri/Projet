...
def films_edit():
    ...
    return render_template("films/films_edit.html", data=data_id_films)
...
def films_update():
    ...
    if request.method == 'POST':
        try:
            ...
            # Récupérer la valeur de "id_films" du formulaire html "films_edit.html"
            # l'utilisateur clique sur le lien "edit" et on récupére la valeur de "id_films"
            # grâce à la variable "id_films_edit_html"
            # <a href="{{ url_for('film_edit', id_films_edit_html=row.id_films) }}">Edit</a>
            id_films_edit = request.values['id_films_edit_html']
            ...
            valeur_edit_list = [{'id_films': id_films_edit, 'intitule_films': name_films}]
            ...
            if not re.match("^([A-Z]|[a-z\u00C0-\u00FF])[A-Za-z\u00C0-\u00FF]*['\\- ]?[A-Za-z\u00C0-\u00FF]+$", name_films):
                ...
                # Constitution d'un dictionnaire et insertion dans la BD
                valeur_update_dictionnaire = {"value_id_films": id_films_edit, "value_name_films": name_films}
...
def films_select_delete():
    ...
    if request.method == 'GET':
        try:
            ...
            id_films_delete = request.args.get('id_films_delete_html')
    ...
    return render_template('films/films_delete.html', data = data_id_films)
...
def films_delete():
    ...
    if request.method == 'POST':
        try:
            ...
            id_films_delete = request.form['id_films_delete_html']
            # Constitution d'un dictionnaire et insertion dans la BD
            valeur_delete_dictionnaire = {"value_id_films": id_films_delete}
