...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.26 Définition d'une "route" /mails_personnes_afficher_concat
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.21 Définition d'une "route" /gf_edit_mail_personne_selected
...
def gf_edit_mail_personne_selected ():
    if request.method == "GET":
        try:
            ...
            # OM 2020.04.21 Récupère la valeur de "ID_Personne" du formulaire html "mails_personnes_afficher.html"
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.26 Définition d'une "route" /gf_update_mail_personne_selected
# Récupère la liste de tous les mails du personne sélectionné.
# Nécessaire pour afficher tous les "TAGS" des mails, ainsi l'utilisateur voit les mails à disposition
# ---------------------------------------------------------------------------------------------------
...
def gf_update_mail_personne_selected ():
    if request.method == "POST":
        try:
            ...
            # OM 2020.04.29 Une liste de "ID_Mail" qui doivent être effacés de la table intermédiaire "t_pers_a_mail".
