...
# OM 2020.04.16 Gestions des "routes" FLASK pour la table intermédiaire qui associe les serveurs et les locations.
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.26 Définition d'une "route" /locations_serveurs_afficher_concat
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.21 Définition d'une "route" /gf_edit_location_serveur_selected
...
def gf_edit_location_serveur_selected ():
    if request.method == "GET":
        try:
            ...
            # OM 2020.04.21 Récupère la valeur de "ID_Serveur" du formulaire html "locations_serveurs_afficher.html"
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.26 Définition d'une "route" /gf_update_location_serveur_selected
# Récupère la liste de tous les locations du serveur sélectionné.
# Nécessaire pour afficher tous les "TAGS" des locations, ainsi l'utilisateur voit les locations à disposition
# ---------------------------------------------------------------------------------------------------
...
def gf_update_location_serveur_selected ():
    if request.method == "POST":
        try:
            ...
            # OM 2020.04.29 Une liste de "ID_Location" qui doivent être effacés de la table intermédiaire "t_pers_a_location".
            ...
            # OM 2020.04.29 Une liste de "ID_Location" qui doivent être ajoutés à la BD
