...
# OM 2020.04.16 Gestions des "routes" FLASK pour la table intermédiaire qui associe les serveurs et les personnes.

from flask import render_template, request, flash, session
from APP_FILMS import obj_mon_application
from APP_FILMS.Demandeurs.data_gestion_demandeurs import GestionPersonnes
from APP_FILMS.Personnes_Serveurs.data_gestion_personnes_serveurs import GestionPersonnesServeurs


# ---------------------------------------------------------------------------------------------------
# OM 2020.04.26 Définition d'une "route" /personnes_serveurs_afficher_concat
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.21 Définition d'une "route" /gf_edit_personne_serveur_selected
...
def gf_edit_personne_serveur_selected ():
    if request.method == "GET":
        try:
            ...
            # OM 2020.04.21 Récupère la valeur de "id_serveur" du formulaire html "personnes_serveurs_afficher.html"
...
# ---------------------------------------------------------------------------------------------------
# OM 2020.04.26 Définition d'une "route" /gf_update_personne_serveur_selected
# Récupère la liste de tous les personnes du serveur sélectionné.
# Nécessaire pour afficher tous les "TAGS" des personnes, ainsi l'utilisateur voit les personnes à disposition
# ---------------------------------------------------------------------------------------------------
...
def gf_update_personne_serveur_selected ():
    if request.method == "POST":
        try:
            ...
            # OM 2020.04.29 Une liste de "id_personne" qui doivent être effacés de la table intermédiaire "t_personnes_serveurs".
